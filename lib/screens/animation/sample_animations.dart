...
import 'package:flutter_web_sample/screens/animation/animation_dialog_route.dart';
import 'package:flutter_web_sample/screens/animation/page1.dart';
import 'package:flutter_web_sample/screens/animation/page2.dart';

import '../../constants.dart';

class SampleAnimations extends StatefulWidget {
  @override
  _SampleAnimationsState createState() => _SampleAnimationsState();
}
...
class _SampleAnimationsState extends State<SampleAnimations> {
  ...
  _onButtonTapPopup(Widget page) {
    Navigator.push(
        context, AnimationDialogRoute(builder: (BuildContext context) => page));
  }
